<template>
  <div class="phone-viewport">
    ...
    <md-sidenav class="md-left" ref="leftSidenav" @open="open('Left')" @close="close('Left')" md-swipeable>
      ...
      <md-list>
        <md-list-item>
          <router-link @click.native="toggleLeftSidenav" exact to="/todos">Todos<md-icon>view_list</md-icon></router-link>
        </md-list-item>

        <md-list-item>
          <router-link @click.native="toggleLeftSidenav" exact to="/tokens">Tokens<md-icon>security</md-icon></router-link>
        </md-list-item>
        ...
        <md-list-item>
          <router-link @click.native="toggleLeftSidenav" exact  to="/cordova">Cordova<md-icon>important_devices</md-icon></router-link>
        </md-list-item>
